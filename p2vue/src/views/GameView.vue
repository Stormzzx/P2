...
body:before {
    content: "victory, reload the page to Restart!";
    color: #222;
...
#level {
    ...
    * {
    ...
    .inner>span {
        ...
        @keyframes approach {
            to {
                transform: rotateX(var(--x)) rotateY(var(--y)) scale(0.75) translateZ(var(--z, 50px));
            }
        }
...
#logo {
    position: fixed;
    background: url("https://assets.codepen.io/383755/580b57fcd9996e24bc43c34d.png") 50% 50% / auto 40vh no-repeat,
        rgba(0, 0, 0, 0.75);
    z-index: 10;
    width: 100vw;
    height: 100vh;
    ...
    @supports (animation-timeline: scroll()) {
        &:after {
            content: "Press space to move and start";
            font-size: 1vh;
        }
    }
...
#hud {
    ...
    &:before {
        ...
        background: url("https://assets.codepen.io/383755/grin-doomguy.gif") 0% 50% / contain no-repeat,
            #666;
    }
}
</style>
...
<style>
/* author: https://codepen.io/cobra_winfrey/pen/oNOMRav
Adam Kuhn */
@import url("https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap");
